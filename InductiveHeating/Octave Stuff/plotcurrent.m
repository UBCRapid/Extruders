figure();
title("Current versus frequency and temperature");
ylabel("Current (A)");
xlabel("Frequency (Hz)");
...
%	colour_imag = [ (index1/numtemps), 0.5, 0];
	...
	%Prepare the data
	currentplot = current(:,index1);

	% plot the graphs
	semilogx(freqrange,currentplot,"linewidth",2,"color",colour_mag)
